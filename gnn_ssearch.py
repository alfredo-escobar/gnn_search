...
def reorder_embeddings(visual_embeddings, text_embeddings, ve_catalog, te_catalog):
    ...
    with open(ve_catalog, 'r', encoding="cp1252") as file_ve, open(te_catalog, 'r', encoding="cp1252") as file_te:
...
if __name__ == '__main__' :
    ...
    if pargs.mode == 'compute_test_queries':
        ...
        with open(filename_ve_test, 'w', encoding="cp1252") as file_ve_test:
        ...
        with open(filename_ve, 'r', encoding="cp1252") as file_ve:
            lines_ve = file_ve.read().splitlines()
        # ----------------
