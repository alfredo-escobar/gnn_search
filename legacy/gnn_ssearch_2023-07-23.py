...
def train_visual(visual_embeddings, text_embeddings, iterations, lr, mAP_dictionary = None):
    ...
    for op in range(iterations + 1):
        ...
        with tf.GradientTape() as t:
            ...
            #loss = loss_by_visual_text_contrast(curr_similarity_visual, curr_similarity_text, batch_indexes)
            loss = loss_unet(curr_similarity_visual, curr_similarity_text, batch_indexes)
