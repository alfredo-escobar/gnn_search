...
def get_100_randoms():
    ...
    if count == k:
        np.save(os.path.join(save_folder, "test_set_integers.npy"), random_integers)
...
#get_100_randoms()
#sort_npy_file("test_set_integers.npy", "test_set_integers_2.npy")
npy_to_json("./catalogues/UNIQLO/test_set_integers.npy")